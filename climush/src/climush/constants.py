...
with open((constants_module_parent / 'data' / 'degeneracy_codes.pickle'), 'rb') as pickle_in:
...
SINTAX_TAXONOMY_ANNOTATIONS = {
    (rank[0] + ':'): rank for \
    rank in TAXONOMIC_RANKS
}
########################################################################################################################
...
# column names to use for dataframe / tab-separated text files written directly by either the amptk or
#   sintax (vsearch) taxonomic assignment algorithms
TAXONOMY_ORIGINAL_COLNAMES = {
    'amptk': {
        0: 'query_seq_header',
        1: 'taxonomy_amptk',
        2: 'taxonomy_usearch',
    ...
    'sintax': {
        0: 'query_seq_header',
        1: 'taxonomy_bootstrap',
        2: 'alignment_strand',
        3: 'taxonomy_restricted',
    },
}
