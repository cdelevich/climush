...
def remove_primers(input_files, output_dir, reference_dir, platform, paired_end, keep_removed_seqs, max_error=0.2, max_untrimmed=None, linked_adapters=None, require_adapters=None, keep_log=True):
